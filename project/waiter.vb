...
Public Class waiter
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        ...
        If String.IsNullOrEmpty(Empno) Or
            ...
            Return
        End If
        Dim query = "INSERT INTO waitertb(Empno,Name,Phonenumber,Address,Salary)VALUES(@Empno,@Name,@Phonenumber,@Address,@Salary)"
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        If String.IsNullOrEmpty(Empno) Or
            ...
            Return
        End If
        Dim query As String = "UPDATE waitertb SET Empno=@Empno,Name=@Name,Phonenumber=@Phonenumber,Address=@Address,Salary=@Salary WHERE Empno=@Empno"
